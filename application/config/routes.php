...
if ($link[3] == 'admin') {
  ...
  $route['blog_internal/(:any)'] = 'blog_internal/index/$1';
  ...
  $route['Manual-de-Camperizacion'] = "manual";

  $route['make-stripe-payment'] = "StripePaymentController";
  $route['handleStripePayment']['post'] = "StripePaymentController/handlePayment";

  $route['make-stripe-book-payment'] = "StripeBookPaymentController";
  $route['handleStripeBookPayment']['post'] = "StripeBookPaymentController/handleBookPayment";
}
