...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <?php echo !empty($title)?$title:'Blog';?>
    </h1>
  </section>
            ...
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                 ...
                 <div class="form-group">
                   <label>Heading</label> 
                  <input type="text" class="form-control" id="heading" name="heading" required value="<?php echo !empty($record->heading)?$record->heading:''?>">
                 ...
                 <div class="form-group">
                  <label>Text</label>
                  <textarea type="name" class="form-control editor" id="text" name="text" required><?php echo !empty($record->text)?$record->text:''?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-btn">
                    <div class="image-upload">                      
                      <img src="<?php echo !empty($record->image)?base_url('uploads/blogs/').$record->image:base_url('assets/admin/img/placeholder.png')?>">
                      <div class="file-btn">
