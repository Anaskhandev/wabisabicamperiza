...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <?php echo !empty($title)?$title:'Users';?>
    </h1>
  </section>
          ...
          <div class="box-body">
            <table id="datatable" class="table table-bordered table-striped">
              ...
              <tbody>            
                ...
                <tr>
                  <td><?php echo $i;?></td>
                  <td><?php echo !empty($record->fn)?$record->fn:'';?></td>
                  <td><?php echo !empty($record->e)?$record->e:'';?></td>
                  <td><?php echo !empty($record->users_created_at)?$record->users_created_at:'';?></td>
                  <td>
