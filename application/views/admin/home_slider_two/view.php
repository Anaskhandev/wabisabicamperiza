              ...
              <div class="box-body box-body-view">
               ...
               <?php if(!empty($record->image)):?>
                <div class="form-group clearfix">
                  ...
                  <span class="col-md-10 view_details"><img src="<?php echo !empty($record->image)?base_url('uploads/home_slider_two/').$record->image:base_url('assets/front/images/placeholder.png')?>" height="80px"></span>
                </div>  
              <?php endif;?> 
