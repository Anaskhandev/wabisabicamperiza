          ...
          <div class="col-md-6">
            <form role="form" action="<?php echo $action;?>" method="post" enctype="multipart/form-data">       
              <div class="box-body">
                  ...
                  <!-- <label>Name</label> -->
                  <input type="hidden" class="form-control" id="name" name="name" required value="<?php echo !empty($record->name)?$record->name:''?>">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group-btn">
                    <div class="image-upload">                      
                      <img src="<?php echo !empty($record->image)?base_url('uploads/home_slider_three/').$record->image:base_url('assets/admin/img/placeholder.png')?>">
                      <div class="file-btn">
